...
class ChainScanner:
    def __init__(self, rpc_url, explorer_api_key, explorer_base_url="https://api.basescan.org/api"):
    ...
    def get_recent_block_range(self):
        ...
        try:
            ...
            # Base has ~2 second block time, so ~43,200 blocks per day
            blocks_per_day = 43200
            start_block = max(1, current_block - (blocks_per_day * 30))  # Last 30 days
